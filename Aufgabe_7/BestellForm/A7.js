...
(function (Aufgabe07) {
    ...
    function writeHTML() {
        ...
        for (let i = 0; i < Aufgabe07.christmasBall.length; i++) {
            ...
            childNodeHTML += " <input type='number' id='numberBalls" + i + "' name='Stepper' step='1' min='0' max='30' value='0' title='" + Aufgabe07.christmasBall[i].name + "' price='" + Aufgabe07.christmasBall[i].price + "'/>";
            childNodeHTML += "<br>";
            continue;
        }
        //Kerzen
        ...
        for (let i = 0; i < Aufgabe07.candle.length; i++) {
            ...
            childNodeHTML += " <input type='number' id='numberCandles" + i + "' name='Stepper' step='1' min='0' max='30' value='0' title='" + Aufgabe07.candle[i].name + "' price='" + Aufgabe07.candle[i].price + "' />";
            childNodeHTML += "<br>";
            continue;
        }
        ...
        for (let i = 0; i < Aufgabe07.lametta.length; i++) {
            ...
            childNodeHTML += " <input type='number' id='numberLametta" + i + "' name='Stepper' step='1' min='0' max='30' value='0' title='" + Aufgabe07.lametta[i].name + "' price=" + Aufgabe07.lametta[i].price + " />";
            childNodeHTML += "<br>";
            continue;
        }
